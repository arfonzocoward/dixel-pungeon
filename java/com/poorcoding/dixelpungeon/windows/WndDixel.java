...
public class WndDixel extends Window {
	...
	public static final int ID_DIXEL		= 100;
	...
	public static void showChapter( int id ) {
		...
		if (text != null) {
			WndDixel wnd = new WndDixel( text );
			if ((wnd.delay = 0.6f) > 0) {
