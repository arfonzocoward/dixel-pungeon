...
public class WndRanking extends WndTabbed {
	...
	private class StatsTab extends Group {
		...
		private static final String TXT_CAMPS	= "Rests at Campfire(s)";
		...
		public StatsTab() {
			...
			pos = statSlot( this, TXT_SOULS, Integer.toString( Statistics.soulsCollected), pos );
			pos = statSlot( this, TXT_CAMPS, Integer.toString( Statistics.campfiresRested), pos );
