...
import com.poorcoding.noosa.SkinnedBlock;
...
import com.poorcoding.dixelpungeon.effects.Ripple;
...
import com.poorcoding.dixelpungeon.sprites.DiscardedItemSprite;
...
import com.poorcoding.dixelpungeon.ui.Banner;
import com.poorcoding.dixelpungeon.ui.BusyIndicator;
import com.poorcoding.dixelpungeon.ui.GameLog;
import com.poorcoding.dixelpungeon.ui.HealthIndicator;
import com.poorcoding.dixelpungeon.ui.QuickSlot;
import com.poorcoding.dixelpungeon.ui.StatusPane;
import com.poorcoding.dixelpungeon.ui.Toast;
...
import com.poorcoding.dixelpungeon.windows.WndBag.Mode;
import com.poorcoding.dixelpungeon.windows.WndGame;
...
public class GameScene extends PixelScene {
	...
	private static final String TXT_WELCOME			= "Welcome to the level %d of Dixel Pungeon!";
	private static final String TXT_WELCOME_BACK	= "Welcome back to the level %d of Dixel Pungeon!";
	private static final String TXT_NIGHT_MODE		= "Be wary: the Dungeons of LelDorado are more dangerous at night!";
	...
	public void create() {
		...
		Music.INSTANCE.play( Assets.DIXEL_TUNE, true );
